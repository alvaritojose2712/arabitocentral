                ...
                <>
                    ...
                    <div className="row mb-2">
                        ...
                        <div className="col d-flex align-items-center">
                            <span className="fs-1 fw-bolder text-success">{moneda(facturaSelectAddItemsSelect.monto)}</span>
                        </div>
                    </div>
                    <div className="row">
                        <div className="col">
                            <table className="table table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th className="">SUBTOTAL BASE F</th>
                                        <th></th>
                                        ...
                                        <tr key={item.id}>
                                            {item.producto?
                                                <>
                                                    ...
                                                    <td className="">{moneda(item.basef*item.cantidad)}</td>
