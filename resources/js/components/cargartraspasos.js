            ...
            <form onSubmit={sendMovimientoBanco}>
                ...
                <div className="form-group mb-1">
                    ...
                    <div className="input-group w-50 mt-1">
                        ...
                        {iscomisiongasto?
                            <input type="text" className="form-control" size={5} placeholder="% Comión" value={comisionpagomovilinterban} onChange={event=>setcomisionpagomovilinterban(number(event.target.value))}/>
                        :null}
                    </div>
                </div>
                <div className="form-group mb-1">
